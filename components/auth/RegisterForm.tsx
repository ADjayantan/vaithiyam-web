...
function inputStyle(focused: boolean, hasError: boolean): React.CSSProperties {
  return {
    ...
    boxShadow:    focused
      ? `0 0 0 3px ${hasError ? 'rgba(139,58,47,0.12)' : 'rgba(26,58,42,0.10)'}`
      : 'none',
  };
}
    ...
    <div style={{ fontFamily: FONT.body, color: T.darkText }}>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        >
          ...
          <a href={loginHref} style={{ color: T.leaf, fontWeight: 700, textDecoration: 'none' }}>
            உள்நுழையுங்கள்
          </a>
        </p>
      </form>
