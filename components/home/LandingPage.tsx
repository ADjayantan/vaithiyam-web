...
import {
  ...
  faLeaf, faBagShopping, faUserCircle,
...
function SiteNav({ cartCount }: { cartCount: number }) {
  return (
    <header style={{ height: 70, background: '#0d0d0d', borderBottom: '1px solid rgba(255,255,255,0.06)', position: 'sticky', top: 0, zIndex: 100 }}>
